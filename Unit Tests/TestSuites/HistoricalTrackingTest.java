 ...
 * @author MsimeleloG
 */
public class HistoricalTrackingTest {
    
    static TestMarshall instance;
    
    public HistoricalTrackingTest()
    {
    ...
    {
        System.out.println("Mix Telematics Test Pack");   
        instance = new TestMarshall("TestPacks\\HistoricalTracking12345.xlsx", Enums.BrowserType.Chrome);
        instance.runKeywordDrivenTests();
    }
