 ...
 * @author BabalwaV
 */
public class CreateNewAsset4 extends BaseClass{
    int counter = 1;
    String errorMsg;
    TestEntity testData;
    
    public CreateNewAsset4(TestEntity testData){
    ...
    public boolean ClickAsset(){
        if(!SeleniumDriverInstance.clickElementByXpath("//A[@ng-href='#/fleet-admin/assets'][text()='Assets']")){
            errorMsg = "Could not click on asset button.";
            return false;
        }
     ...
     public boolean AddDetails(){
         ...
         if(!SeleniumDriverInstance.enterTextByXpath("(//INPUT[@type='text'])[1]", "Babalwa Vas")){
     ...
     SeleniumDriverInstance.enterTextByXpath("//INPUT[@ui-if='!duplicate']", "123454");
     ...
     SeleniumDriverInstance.selectFromDropDownListUsingXpath("//select[@name =\"country\"]", "South Africa");
      ...
      SeleniumDriverInstance.enterTextByXpath("//INPUT[@ng-switch-when='true']", "4");
